...
<head>
    ...
    <!-- Plugin CSS -->
    <link href="front-end/styles/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="front-end/styles/css/owl.carousel.css" rel="stylesheet" type="text/css">
    <link href="front-end/styles/css/owl.theme.css" rel="stylesheet" type="text/css">
    <link href="front-end/styles/css/owl.transitions.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-inverse navbar-expanded" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">
                <img class="img-fluid" src="front-end/images/agency/logo.svg" alt="">
            </a>
    ...
    <!-- Call to Action -->
    <section class="call-to-action" style="background-image: url('front-end/images/backgrounds/bg-quote.jpg');">
